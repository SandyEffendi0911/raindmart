        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <form name="login_form" id="login_form">
                    ...
                    <div class="uk-form-row">
                        <a onclick="loginUser()" class="md-btn md-btn-primary md-btn-block md-btn-large">Sign In</a>
                        {{-- <button type="submit" class="md-btn md-btn-primary md-btn-block md-btn-large">Sign In</a> --}}
                    </div>
